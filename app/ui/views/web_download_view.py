...
class WebDownloadView:
    ...
    def __init__(self, page, assets_dir):
        self.page = page
    ...
    def _create_eps_selection_card(self, eps_name, color, description):
        ...
        def on_hover(e):
            ...
            card_container.shadow = ft.BoxShadow(
                ...
                color=ft.Colors.with_opacity(0.10 if e.data == "true" else 0.06, COLORS["text_primary"]),
    ...
    def build(self):
        ...
        self.header = ft.Container(
            ...
            padding=ft.padding.only(top=30, bottom=35)
        )
